...
<body>
    <div id="main-div">
        ...
        <div id="info-page">
            ...
            <div id="pvnt">
                <input id="prev" name="prev" class="prxt" type="submit" value="<=prev" onclick="transfer_data2()">
                <input id="rese" name="rese" class="prxt" type="reset" value="clear">
                <input id="next" name="next" class="prxt" type="submit" value="next=>" onclick="transfer_data2()">
            </div>
            </form>
            <div id="smbt-row">
